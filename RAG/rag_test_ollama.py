...
# Ollama local — ajuste IP/porta e nome do modelo conforme seu setup
OLLAMA_HOST = "http://200.144.192.67:11434"
...
# --- Embeddings continuam via OpenRouter, pra manter o retrieval idêntico ---
# (assim a comparação isola só a etapa de geração: Ollama local vs. modelo pago)
...
# --- Geração via Ollama local, direto na porta 11434, sem Open WebUI ---
